...
spinbox1.pack()
q2 = tk.Label(frame2,text="How many days a week do you eat processed and packaged foods",font=('Arial',16,"bold")).pack(pady=(10,10))
spinbox2 = tk.Spinbox(frame2, from_=0, to=7, width=10, relief="sunken", repeatdelay=300, repeatinterval=7,font=("Arial", 12))
spinbox2.pack()
q6 = tk.Label(frame2,text="How many days a week do you eat animal based products.",font=('Arial',16,"bold")).pack(pady=(10,10))
spinbox6 = tk.Spinbox(frame2, from_=0, to=7, width=10, relief="sunken", repeatdelay=300, repeatinterval=7,font=("Arial", 12))
spinbox6.pack()
q3 = tk.Label(frame2,text="How many days a week do you use more than 90 gallons of water",font=('Arial',16,"bold")).pack(pady=(10,10))
spinbox3 = tk.Spinbox(frame2, from_=0, to=7, width=10, relief="sunken", repeatdelay=300, repeatinterval=7,font=("Arial", 12))
spinbox3.pack()
q4 = tk.Label(frame2,text="How many days a week do you fill up your trash can (approx 13 gallon)",font=('Arial',16,"bold")).pack(pady=(10,10))
spinbox4 = tk.Spinbox(frame2, from_=0, to=7, width=10, relief="sunken", repeatdelay=300, repeatinterval=7,font=("Arial", 12))
spinbox4.pack()
q5 = tk.Label(frame2,text="How many days a week do you wear clothes made by unsustainable brands",font=('Arial',16,"bold")).pack(pady=(10,10))
